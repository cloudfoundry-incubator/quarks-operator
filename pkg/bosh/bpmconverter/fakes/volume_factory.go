...
type FakeVolumeFactory struct {
	GenerateBPMDisksStub        func(string, *manifest.InstanceGroup, bpm.Configs, string) (bpmconverter.BPMResourceDisks, error)
	...
	generateBPMDisksReturns struct {
		result1 bpmconverter.BPMResourceDisks
		result2 error
	}
	...
	GenerateDefaultDisksStub        func(string, *manifest.InstanceGroup, string, string) bpmconverter.BPMResourceDisks
...
func (fake *FakeVolumeFactory) GenerateBPMDisks(arg1 string, arg2 *manifest.InstanceGroup, arg3 bpm.Configs, arg4 string) (bpmconverter.BPMResourceDisks, error) {
...
func (fake *FakeVolumeFactory) GenerateBPMDisksCalls(stub func(string, *manifest.InstanceGroup, bpm.Configs, string) (bpmconverter.BPMResourceDisks, error)) {
	fake.generateBPMDisksMutex.Lock()
...
func (fake *FakeVolumeFactory) GenerateBPMDisksReturns(result1 bpmconverter.BPMResourceDisks, result2 error) {
	fake.generateBPMDisksMutex.Lock()
	defer fake.generateBPMDisksMutex.Unlock()
...
func (fake *FakeVolumeFactory) GenerateBPMDisksReturnsOnCall(i int, result1 bpmconverter.BPMResourceDisks, result2 error) {
	fake.generateBPMDisksMutex.Lock()
	defer fake.generateBPMDisksMutex.Unlock()
	fake.GenerateBPMDisksStub = nil
...
func (fake *FakeVolumeFactory) GenerateDefaultDisks(arg1 string, arg2 *manifest.InstanceGroup, arg3 string, arg4 string) bpmconverter.BPMResourceDisks {
...
func (fake *FakeVolumeFactory) GenerateDefaultDisksCalls(stub func(string, *manifest.InstanceGroup, string, string) bpmconverter.BPMResourceDisks) {
	fake.generateDefaultDisksMutex.Lock()
...
func (fake *FakeVolumeFactory) GenerateDefaultDisksReturns(result1 bpmconverter.BPMResourceDisks) {
	fake.generateDefaultDisksMutex.Lock()
	defer fake.generateDefaultDisksMutex.Unlock()
...
func (fake *FakeVolumeFactory) GenerateDefaultDisksReturnsOnCall(i int, result1 bpmconverter.BPMResourceDisks) {
	fake.generateDefaultDisksMutex.Lock()
	defer fake.generateDefaultDisksMutex.Unlock()
	fake.GenerateDefaultDisksStub = nil
