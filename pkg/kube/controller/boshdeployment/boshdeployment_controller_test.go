...
import (
	...
	cfd "code.cloudfoundry.org/cf-operator/pkg/kube/controller/boshdeployment"
	cfakes "code.cloudfoundry.org/cf-operator/pkg/kube/controller/boshdeployment/fakes"
	"go.uber.org/zap"
