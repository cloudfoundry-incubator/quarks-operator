...
import (
	...
	scheme "code.cloudfoundry.org/cf-operator/pkg/client/clientset/versioned/scheme"
...
func newBOSHDeployments(c *FissileV1alpha1Client, namespace string) *bOSHDeployments {
